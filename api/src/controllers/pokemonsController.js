...
//Función crear pokemon:
const createPokemonController = async (name, img, hp, attack, defense, speed, height, weight, type = 'unknown') => {
    ...
    const typePokemon = type.split(',');
    typePokemon.map(async (t) => {
